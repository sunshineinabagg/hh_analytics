...
class Analyzer:
    ...
    def analyze_salaries_by_role(self):
        """
        task 1. Salary level analysis in the following roles (`professional_role`)
        :return:
        pd.DataFrame: A DataFrame containing salary statistics grouped by professional role,
                      including the share of vacancies with salaries
        """
    ...
    def analyze_salaries_by_city(self):
        """
        task 2. Analysis of salary expectations by city (`city`)
        :return:
        pd.DataFrame: A DataFrame containing salary statistics grouped by city,
                      including the share of vacancies with salaries.
        """
    ...
    def analyze_roles_count(self):
        """
        task 3. Analysis of the demand for roles
        :return:
        pd.DataFrame: A DataFrame containing the count and share of vacancies grouped by professional role.
        """
    ...
    def analyze_salaries_by_experience(self):
        """
        task4. Analysis of work experience (`experience`) and its impact on salary
        :return:
        pd.DataFrame: A DataFrame containing salary statistics grouped by experience category
                      and professional role, including total vacancies and vacancies with salaries.
        """
